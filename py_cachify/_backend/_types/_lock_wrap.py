...
class AsyncLockWrappedF(Protocol[_P, _R]):
    ...
    async def is_locked(self, *args: _P.args, **kwargs: _P.kwargs) -> None: ...  # pragma: no cover
...
class _AsyncLockWrappedFM(Protocol[_S_co, _P, _R]):
    __wrapped__: Callable[_P, Awaitable[_R]]  # pragma: no cover
    is_locked: Callable[Concatenate[_S_co, _P], Awaitable[_R]]  # pragma: no cover
    release: Callable[Concatenate[_S_co, _P], Awaitable[_R]]  # pragma: no cover
...
class SyncLockWrappedF(Protocol[_P, _R]):
    ...
    def is_locked(self, *args: _P.args, **kwargs: _P.kwargs) -> None: ...  # pragma: no cover
...
class _SyncLockWrappedFM(Protocol[_S_co, _P, _R]):
    __wrapped__: Callable[_P, _R]  # pragma: no cover
    is_locked: Callable[Concatenate[_S_co, _P], _R]  # pragma: no cover
    release: Callable[Concatenate[_S_co, _P], _R]  # pragma: no cover
